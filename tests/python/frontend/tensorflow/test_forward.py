...
def test_structure_and_span():
    """Test Structure and span of frequently-used models are the same as expected"""
    ...
    def _verify_fully_connected_bias_add():
        def _res():
            in_shape = (1, 10)
            kernel_shpae = (10, 10)
            kernel_in = np.ones(kernel_shpae)
    ...
    _verify_fully_connected_bias_add()
    _verify_reshape()
    _verify_batch_norm()
