...
def TupleWithFields(tuple, fields=None, virtual_device=None, span=None):
    """
    ...
    fields.
    """
    return _ffi_api.TupleWithFields(tuple, fields, virtual_device, span)
...
def VarWithFields(var, vid=None, type_annotation=None, virtual_device=None, span=None):
    """
    ...
    fields.
    """
    return _ffi_api.VarWithFields(var, vid, type_annotation, virtual_device, span)
...
def LetWithFields(let, var=None, value=None, body=None, virtual_device=None, span=None):
    """
    ...
    fields.
    """
    return _ffi_api.LetWithFields(let, var, value, body, virtual_device, span)
